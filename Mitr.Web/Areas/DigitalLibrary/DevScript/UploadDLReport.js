...
function Export() {
        ...
        CommonAjaxMethod(virtualPath + 'DigitalLibrary/DLUploadReportInCSV', obj, 'GET', function (response) {
            var link = document.createElement("a");
            link.download = "UploadDLReport.csv";
            link.href = "/Attachments/SampleCSVFile/UploadDLReport.csv";
            link.click();
        });
