                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (result.ErrorMessage == "") {
                            ...
                            SuccessToaster(result.ErrorMessage);
...
function FillSubCategory(data)
{
    ...
    CommonAjaxMethod(virtualPath + 'DigitalLibrary/GetMatrix', { category: tagName }, 'GET', function (response) {
        ...
        $ele2.append($('<option/>').val(data[0].Document_Category).text(data[0].Document_Category));
...
{
    CommonAjaxMethod(virtualPath + 'DigitalLibrary/GetMyRequestContent',  null, 'GET', function (response)
    {
