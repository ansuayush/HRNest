...
function Export() {
        ...
        CommonAjaxMethod(virtualPath + 'DigitalLibrary/DLDownloadReportInCSV', obj, 'GET', function (response)
        {
            var link = document.createElement("a");
            link.download = "DownloadDLReport.csv" ;
            link.href = "/Attachments/SampleCSVFile/DownloadDLReport.csv";
            link.click();
        });
