...
function SaveQuotationEntry(from) {
    ...
    var isValidItemDescription = true;
    if (from == 2) {
    ...
    if (isValidJust) {
        ...
        if (checkValidationOnSubmit('Mandatory') == true && checkDate3 == true && isValiddeliverables == true && isValidfileScopeNewName == true && isLineItemdocumentUpload == true && isValidIsRecommend == true && isValidItemDescription==true) {
            if (isValid > 0) {
                var objQuotation =
                {
...
function SaveContract(from) {
    ...
    if (UploadSignedDocuments.length > 0) {
        ...
        if (checkValidationOnSubmit('Mandatory') == true && checkDate3 == true && isValiddeliverables == true) {
...
function FillInvoiceDetail(data3) {
    ...
    var array = data3;
    $('#tblDetailsofDeliverable').DataTable().destroy();
...
function InvoiceApprove(ctrl, from, type) {
    ...
    if ($('#lblInvoiceAmount_' + controlNo).text() != "") {
        lblInvoiceAmount_ = parseInt($('#lblInvoiceAmount_' + controlNo).text().replace(/,/g, ''));
