$(document).ready(function () {
    BindState();
    $("#fileUploadEmpanel").change(function () {
        UploadocumentImpanelDoc();
    })
        ...
        , 'GET', function (response) {
            ...
            for (var i = 0; i < dAttachements.length; i++) {
                ...
                if (i < 16) {
                    ...
                    $('#lblRemark' + fileId).text(dAttachements[i].Remarks);
                    ...
                    DocArrayId = dAttachements[i].id;
                    var objAttach =
                    {
                        SRNo: dAttachements[i].SRNo,
                        Id: DocArrayId,
...
function DownloadFile(id) {
    ...
    if (fileURl != null || fileURl != undefined) {
        ...
        FailToaster("File is not attached for this.");
        //document.getElementById('hReturnMessage').innerHTML = "File is not attached for this.";
        //$('#btnShowModel').click();
    }
...
function RegistrationDeactivate()
{
    ...
    if ($('#txtDeactivateReason').val() == "") {
        isValidEmpan = false;
        $('#sptxtDeactivateReason').show();
    }
    else {
        $('#sptxtDeactivateReason').hide();
    }
    ...
    if (isValidEmpan == true) {
        var obj = {
            ...
            Action: 2,       
            DeactivateReason: $('#txtDeactivateReason').val()
        }
