            ...
            if (data1.length > 0)
            {
                ...
                CommonAjaxMethod(virtualPath + 'ProcurementRequest/BindProjectDetails', { id: RequestId, IsBindLine: 9 }
                    , 'GET', function (response) {
                        ...
                        $("#hdnfileScopeNewName").val(dd3[0].ScopeofworkNewFileName);
                        $("#hdnfileScopeActualName").val(dd3[0].ScopeofworkActualFileName);
                        $("#hdnfileScopeFileUrl").val(dd3[0].ScopeofworkActualFileUrl);
