...
function SaveRelationshipMaster()
{
    if (checkValidationOnSubmit('Mandatory') == true)
    {
        ...
        var obj = {
            ID: catId,
            RelationshipMaster: $('#txtSubCate').val(),
            TableType: DropDownTypeEnum.ProcurementRelationshipMaster,
            Code: "SC",
            MasterTableId: $('#hdnMasterTableId').val(),
            UserId: loggedinUserid,
            IPAddress: $('#hdnIP').val() ? "" : " "   
        }
        CommonAjaxMethod(virtualPath + 'RelationshipMaster/SaveRelationshipMaster', obj, 'POST', function (response)
        {
            BindRelationshipMaster();
            ClearFormControl();       
            $('#sc').modal('hide')
...
{
    CommonAjaxMethod(virtualPath + 'RelationshipMaster/BindRelationshipMaster', null, 'GET', function (response) {
...
{
    ClearFormControl();
    CommonAjaxMethod(virtualPath + 'RelationshipMaster/GetRelationshipMaster', { id: id }, 'GET', function (response)
    {  
