...
function ViewRequestDetails(reqId) {
    CommonAjaxMethod(virtualPath + 'HRRequest/GetHRTrainingDetails', { RequIds: reqId, inputData: 2 }, 'GET', function (response) {
        ...
        if (ReqDetails.length > 0) {
            ...
            //document.getElementById('lblRequestedFor').innerHTML = ReqDetails[0].RequestedFor;
