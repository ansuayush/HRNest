...
function EditComplianceMaster(id) {
    ...
    CommonAjaxMethod(virtualPath + 'ComplianceTransaction/GetComplianceMasterById', { id: id }, 'GET', function (response) {
        ...
        $('#dueDate').val(ChangeDateFormatToddMMYYY(complianceMaster.DueDate));
