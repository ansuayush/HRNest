$(document).ready(function () {
    ...
    LoadMasterDropdown('ddlLEDDesignation', {
        ParentId: 0,
        masterTableType: 0,
        isMasterTableType: false,
        isManualTable: true,
    ...
    CommonAjaxMethod(virtualPath + 'OnboardingRequest/BindonboardingProcessData', { CandidateId: CandidateId, inputData: 9 }, 'GET', function (response) {
        ...
        if (candidateStatus.length > 0) {
            ...
            if (candodate_Status == true) {
                ...
                $("#btnRegistrationNext").prop('disabled', true);
                $("#btnRegistrationNextAddRow").prop('disabled', true);
            }
            else {
                $("#btnRegistrationSave").prop('disabled', false);
                $("#btnRegistrationNext").prop('disabled', false);
                $("#btnRegistrationNextAddRow").prop('disabled', false);
            }
        }
        if (registrationData.length > 0) {
            ...
            $('#ddlGenderName').val(registrationData[0].Gender == "0" ? "Select" : registrationData[0].Gender).trigger('change');
            $('#ddlMaritalStatus').val(registrationData[0].MaritalStatus == "0" ? "Select" : registrationData[0].MaritalStatus).trigger('change');
            $('#ddlNationality').val(registrationData[0].Nationality == "0" ? "Select" : registrationData[0].Nationality).trigger('change');
            $('#ddlSpousePartner').val(registrationData[0].SpousePartner == "0" ? "Select" : registrationData[0].SpousePartner).trigger('change');
            $('#txtSpousesName').val(registrationData[0].SpousesName);
            $('#txtPartnersName').val(registrationData[0].PartnersName);
            ...
            $('#ddlCountry').val(registrationData[0].Country == "0" ? "Select" : registrationData[0].Country).trigger('change');
            ...
            $('#ddlLACountry').val(registrationData[0].LACountry == "0" ? "Select" : registrationData[0].LACountry).trigger('change');
            $('#ddlLAState').val(registrationData[0].LAState == "0" ? "Select" : registrationData[0].LAState).trigger('change'),
                $('#ddlLACity').val(registrationData[0].LACity == "0" ? "Select" : registrationData[0].LACity).trigger('change');
            ...
            $('#ddlPACountry').val(registrationData[0].PACountry == "0" ? "Select" : registrationData[0].PACountry).trigger('change');
            $('#ddlPAState').val(registrationData[0].PAState == "0" ? "Select" : registrationData[0].PAState).trigger('change');
            $('#ddlPACity').val(registrationData[0].PACity == "0" ? "Select" : registrationData[0].PACity).trigger('change');
            ...
            $('#ddlSpecialAbility').val(registrationData[0].SpecialAbility == "0" ? "Select" : registrationData[0].SpecialAbility).trigger('change');;
            ...
            $('#ddlBloodGroup').val(registrationData[0].BloodGroup == "0" ? "Select" : registrationData[0].BloodGroup).trigger('change');;
            ...
            //$('#chkLIFlagPan').val(registrationData[0].LIFlagPan);
            ...
            //$('#chkLIFlagAadhar').val(registrationData[0].LIFlagAadhar);
            ...
            CheckLIFlagVoterID();
            //$('#chkLIFlagVoterID').val(registrationData[0].LIFlagVoterID);
            $('#txtLIVoterIDNo').val(registrationData[0].LIVoterIDNo);
            //$('#chkLIFlagPassport').val(registrationData[0].LIFlagPassport);
            ...
            //$('#chkLIFlagDIN').val(registrationData[0].LIFlagDIN);
            ...
            //$('#chkLIFlagUAN').val(registrationData[0].LIFlagUAN);
            ...
            //$('#chkLIFlagPIOOCI').val(registrationData[0].LIFlagPIOOCI);
            ...
            //$('#chkLIFlagDrivingLicense').val(registrationData[0].LIFlagDrivingLicense);
            ...
            //$('#chkLIFlagPTAD').val(registrationData[0].LIFlagPTAD);
            document.getElementById('chkLIFlagPTAD').checked = registrationData[0].LIFlagPTAD;
            CheckLIFlagPTAD();
            $('#txtLIAmount').val(registrationData[0].LIAmount);
            $('#ddlResidentialStatus').val(registrationData[0].ResidentialStatus == "0" ? "Select" : registrationData[0].ResidentialStatus).trigger('change');;
            $('#ddlBenefitsNameOfTheBank').val(registrationData[0].BenefitsNameOfTheBank == "0" ? "Select" : registrationData[0].BenefitsNameOfTheBank).trigger('change');
            $('#ddlBenefitsTypeOfBankAccount').val(registrationData[0].BenefitsTypeOfBankAccount == "0" ? "Select" : registrationData[0].BenefitsTypeOfBankAccount).trigger('change');
            ...
            $('#ddlLEDDesignation').val(registrationData[0].LEDDesignation).trigger('change');
            ...
            $('#ddlSeatPreference').val(registrationData[0].SeatPreference == "0" ? "Select" : registrationData[0].SeatPreference).trigger('change');
            $('#ddlMealPreference').val(registrationData[0].MealPreference == "0" ? "Select" : registrationData[0].MealPreference).trigger('change');
        ...
        if (airlineDetailsData.length > 0) {
            ...
            for (let i = 0; i < dataArry.length; i++) {
                dataArry[i].RowNum = parseInt(i + 1);
                var newtbblData = "<tr><td>" + parseInt(i + 1) + "</td><td>" + dataArry[i].AirlineName + "</td><td>" + dataArry[i].FrequentFlyerNumber + "</td><td style='text-align: center;' class='text-center' ><a class='HideClass'  title='Click to Remove' data-toggle='tooltip' data-original-title='Click to Remove' onclick='DeleteDocArrayRows(this," + parseInt(i + 1) + ")'><i class='fas fa-window-close m-0 red-clr' aria-hidden='true'></i> </a> </td></tr>";
...
function RedirectToAttachment() {
    ...
    if (valid == true) {
        ...
        var RegistrationDetails = {
            ...
            MaritalStatus: $('#ddlMaritalStatus').val() == 'Select' ? 0 : $('#ddlMaritalStatus').val(),
            ...
            LACountry: $('#ddlLACountry').val() == 'Select' ? 0 : $('#ddlLACountry').val(),
            ...
            PAState: $('#ddlPAState').val() == 'Select' ? 0 : $('#ddlPAState').val(),
            ...
            LEDDesignation: $('#ddlLEDDesignation').val(),
        ...
        CommonAjaxMethod(virtualPath + 'OnboardingRequest/SaveRegistrationData', obj, 'POST', function (response) {
            ...
            FailToaster("Proceed to attachment.");
            window.location.href = virtualPath + 'Onboarding/Attachment?id=' + CandidateId;
        });
    }
}
...
function SaveRegistrationDetails() {
    ...
    //if (valid == true) {
        ...
        var RegistrationDetails = {
            ...
            PALandlineNo: $('#txtPALandlineNo').val(),
            PAPersonalEmailID: $('#txtPAPersonalEmailID').val(),
            SpecialAbility: $('#ddlSpecialAbility').val() == 'Select' ? 0 : $('#ddlSpecialAbility').val() ,
            MDFormC3: $('#txtMDformC3').val(),
            MDConditionC3: $('#txtMDconditionC3').val(),
            MDHospitalPhysicianName: $('#txtMDHospitalPhysicianName').val(),
            MDPhoneNumber: $('#txtMDPhoneNumber').val(),
            ...
            LEDTotalWorkExperience: $('#txtLEDTotalWorkExperience').val(),
            LEDLastAnnualCTC: $('#txtLEDLastAnnualCTC').val(),
            LEDDesignation: $('#ddlLEDDesignation').val() == 'Select' ? 0 : $('#ddlLEDDesignation').val() ,
            LEDLocation: $('#txtLEDLocation').val(),
            LEDTermofEmployment: $('#txtLEDTermofEmployment').val(),
            LEDInCaseOfGap: $('#txtLEDInCaseOfGap').val(),
            LEDAmountOfIncome: $('#txtLEDAmountOfIncome').val(),
