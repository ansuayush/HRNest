    ...
    CommonAjaxMethod(virtualPath + 'OnboardingRequest/BindonboardingProcessData', { CandidateId: CandidateId, inputData: 9 }, 'GET', function (response) {
        ...
        if (airlineDetailsData.length > 0) {
            ...
            for (let i = 0; i < dataArry.length; i++) {
                ...
                var newtbblData = "<tr><td>" + parseInt(i + 1) + "</td><td>" + dataArry[i].AirlineName + "</td><td>" + dataArry[i].FrequentFlyerNumber + "</td><td style='text-align: center;'><a class='HideClass'  title='Click to Remove' data-toggle='tooltip' data-original-title='Click to Remove' onclick='DeleteDocArrayRows(this," + parseInt(i + 1) + ")'><i class='fas fa-window-close m-0 red-clr' aria-hidden='true'></i> </a> </td></tr>";
