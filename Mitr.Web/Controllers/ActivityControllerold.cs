...
{
    [CheckLoginFilter]
    public class ActivityControllerold : Controller
    {
                ...
                if (Command == "Download")
                {
                    switch (Modal.RadioButton)
                    {
                        ...
                        case "13":
                            ...
                            worksheet.Cells[2, 5].Value = "C-27, 2nd Floor Qutub Institutional Area New Delhi-16";
        ...
        public JsonResult ActivityLogApprovalEMPNonMITR(MonthlyLogNonMitr Modal, FormCollection Collection, string src, string Command)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Command == "Approve" || Command == "Resubmit")
                {
                    ...
                    {
                        Common_SPU.fnCreateMail_Termbaseactivitylog(Convert.ToString(Month), Command, Remarks, chekEMPId);
                    }
